...
class SettingsUart extends StatefulWidget {
   SettingsUart({super.key});

  @override
  State<SettingsUart> createState() => _SettingsUartState();
}

class _SettingsUartState extends State<SettingsUart> {
